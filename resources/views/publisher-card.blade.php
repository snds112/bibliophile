            ...
            <div class=" col-md-4 d-flex ">
                <div class="user-info-container-col p-5 rounded ">
                    ...
                    <div class="user-info-list">
                        <h1 class="card-title">Publisher information:</h1>
                        <br>
                        <span class="user-info-label">Name:</span>
                        <span class="user-info-value">{{ $publisher->name }}</span>
                        <hr>
                        <span class="user-info-label">Email:</span>
                        <span class="user-info-value">{{ $publisher->email }}</span>
                        <hr>
                        <span class="user-info-label">Phone:</span>
                        <span class="user-info-value">{{ $publisher->phone }}</span>
                        <hr>
                        ...
                        <div class="user-info-label-admin d-flex" style="justify-content: center">
                            ...
                            @if (auth()->user()->admin)
                                <form action="/modify-publisher/{{ $publisher->id }}" method="get">
                                    @csrf
            ...
            <div class="col-md-4">
                <div class="card mb-3" style="width: 30rem; height: auto">
                    <div class="row g-0">
                        ...
                        <div class="col-md-12">
                            <div class="card-body">
                                <h2 class="card-title text-center">Books from this publisher</h2>
