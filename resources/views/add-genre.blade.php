...
@section('content')
    <div class="container my-5">
        ...
        <form action="/store-genre" method="Post" id="book-form" enctype="multipart/form-data">
            @csrf
            <div class="row">
                ...
                <div class="col-md-12 rounded shadow p-4" style="background-color: #cfbdb4; color: black">
                    ...
                    <button type="submit" class="btn btn-outline-commment float-end "id="store-genre">Add
                        Genre</button>
